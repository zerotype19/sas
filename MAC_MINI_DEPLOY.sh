#!/bin/bash
# Run this script directly on your Mac mini to deploy the broker update
set -e

echo "╔══════════════════════════════════════════════════════════════╗"
echo "║   🚀 Deploying IBKR Broker Service Update                   ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""

# Backup existing file
echo "📦 Backing up existing main.py..."
cp ~/ibkr-broker/app/main.py ~/ibkr-broker/app/main.py.backup.$(date +%s)
...
# Update main.py (new file with /options/quotes endpoint)
echo "📝 Updating main.py..."
cat > ~/ibkr-broker/app/main.py << 'PYTHON_EOF'
"""
...
# Start service
echo "▶️  Starting broker service..."
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
tail -20 ~/ibkr-broker/broker.err.log
...
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
echo "Test the endpoint from your laptop:"
echo ""
echo "curl -s -X POST \"https://sas-worker-production.kevin-mcgovern.workers.dev/broker/options/quotes\" \\"
echo "  -H \"Content-Type: application/json\" \\"
echo "  -d '{\"contracts\": [{\"symbol\": \"SPY\", \"expiry\": \"2025-11-15\", \"strike\": 585, \"right\": \"C\"}]}' | jq"
